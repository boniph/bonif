...
[Choose a stunning **theme** and **font**](/academic/themes/) for your site. Themes are fully [customizable](/academic/docs/customization/#custom-theme).
...
* [**one-click install using your web browser (recommended)**](/academic/docs/install/#install-with-web-browser)
* [install on your computer using **Git** with the Command Prompt/Terminal app](/academic/docs/install/#install-with-git)
* [install on your computer by downloading the **ZIP files**](/academic/docs/install/#install-with-zip)
* [install on your computer with **RStudio**](/academic/docs/install/#install-with-rstudio)

Then [personalize and deploy your new site](/academic/docs/get-started/).

## Updating

[View the Update Guide](/academic/docs/update/).

Feel free to *star* the project on [Github](https://github.com/gcushen/hugo-academic/) to help keep track of [updates](/academic/updates).
